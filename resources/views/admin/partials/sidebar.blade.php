<aside x-cloak 
    ...
    <div class="flex-1 px-4 overflow-y-auto">
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.student-registrations') }}" class="flex items-center gap-3 px-4 py-2 rounded {{ request()->routeIs('admin.student-registrations') ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 text-gray-300 hover:text-white' }} transition-colors">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.grade-subject-fees') }}" class="flex items-center gap-3 px-4 py-2 rounded {{ request()->routeIs('admin.grade-subject-fees') ? 'bg-gray-800 text-white' : 'hover:bg-gray-800 text-gray-300 hover:text-white' }} transition-colors">
                <i class="fas fa-tags w-5 h-5 flex-shrink-0 text-center"></i>
